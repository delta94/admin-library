  ...
  translation: {
    ...
    game: {
      ...
      fields: {
        ...
        tagline: {
          label: 'Tagline',
          description: 'A tagline is located near the logo on the game page in the store. It can also be used on promotion blocks in different store placements. Avoid duplicating your project’s title. Recommended 160 symbols, max {{limit}}.',
        },
        description: {
          label: 'Description',
          description_start: 'This will make up the content of your game. The best begin with a brief description of the game. After that, you can describe details and list of key features and other information you consider necessary to describe your product. You can use up to {{limit}} characters in this field. ',
          description_end: 'Do not link to other sites in this section!',
        },
        review: {
          label: 'Review',
          description: 'Which of game press reviews you want to include to the game page to help us sell your product better. These reviews are visible to users around the world. You can add max {{limit}} of reviews.',
          press_agent_name: 'Press agent name',
          link: 'Link',
          quote: 'Quote',
          score: 'Score',
          add_press_agent: 'Add press agent',
        },
        external_links: {
          label: 'External Links',
          description: 'If your project has any external pages like a homepage, message board or support page you can add those links here so people can find them.',
          site: 'Game site',
          facebook: 'Facebook',
          reddit: 'Reddit',
          twitter: 'Twitter',
